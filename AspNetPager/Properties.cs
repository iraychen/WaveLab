    ...
    public partial class AspNetPager
    {
        ...
        public string FirstPageText
        {
            get
            {
                ...
                return (obj == null) ? SR.GetString("firstPage") : (string)obj;
            }
        ...
        public string PrevPageText
        {
            get
            {
                ...
                return (obj == null) ? SR.GetString("prevPage") : (string)obj;
            }
        ...
        public string NextPageText
        {
            get
            {
                ...
                return (obj == null) ? SR.GetString("nextPage") : (string)obj;
            }
        ...
        public string LastPageText
        {
            get
            {
                ...
                return (obj == null) ? SR.GetString("lastPage") : (string)obj;
            }
        ...
        public int PageSize
        {
            get
            {
                ...
                return (obj == null) ? int.Parse(System.Web.HttpContext.GetGlobalResourceObject("globalResource", "pageSize").ToString()) : (int)obj;
            }
            set
            {
        ...
        public string SubmitButtonText
        {
            get
            {
                ...
                return (null == obj) ? SR.GetString("submitButtonText").ToString() : (string)obj;
            }
            set
            {
                if (null == value)
        ...
        public string CustomInfoHTML
        {
            get
            {
                ...
                return (null == obj) ? SR.GetString("currentPage") + "&nbsp;" + CurrentPageIndex + "&nbsp;" + SR.GetString("page") + "&nbsp;&nbsp;" +
                    SR.GetString("pageTotal") + "&nbsp;" + PageCount + "&nbsp;" + SR.GetString("page") + "&nbsp;&nbsp;" +
                    SR.GetString("total") + "&nbsp;" + RecordCount + "&nbsp;" + SR.GetString("records") 
                    : (string)obj;
            }
            set
            {
