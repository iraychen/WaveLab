<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SYSRoleEdit.aspx.cs" Inherits="WaveLab.Web.SYSRoleEdit" Title="无标题页"  meta:resourcekey="PageResource1"  %>
   ...
   <tr>
        <td align ="right">
          ...
          <asp:NewButton ID="btnSave" runat="server" Width ="80px"  Text ="<%$ Resources:globalResource,SaveText %>"
               Action ="RoleEdit" OnClientClick="return verify()" onclick="btnSave_Click"/>
          &nbsp;
          <asp:NewButton ID="btnDelete" runat ="server"  Width ="80px" Text ="<%$ Resources:globalResource,DeleteText %>"
               Action ="RoleDelete" onclick="btnDelete_Click"/>
          &nbsp;
