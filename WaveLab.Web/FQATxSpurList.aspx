<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQATxSpurList.aspx.cs" Inherits="WaveLab.Web.FQATxSpurList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="FQATxSpurView.aspx?FQATxSpurId="+value;
            break;
        default:
            break;
    }
