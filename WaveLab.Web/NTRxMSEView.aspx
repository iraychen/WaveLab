<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTRxMSEView.aspx.cs" Inherits="WaveLab.Web.NTRxMSEView" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                        ...
                        <td>
                            <asp:GridView ID="GVResult" runat="server" AllowSorting ="True"  SkinId="skinGridView"
                              ...
                              <Columns>
                                  ...
                                  <asp:BoundField  DataField="LocalMSE" meta:resourcekey="BoundFieldResource4"/>
                                  <asp:BoundField  DataField="LocalRxPowerResult" meta:resourcekey="BoundFieldResource5"/>
                                  <asp:BoundField  DataField="LocalMSEResult" meta:resourcekey="BoundFieldResource6"/>
                                  <asp:BoundField  DataField="RemoteRxPower" meta:resourcekey="BoundFieldResource7"/>
                                  <asp:BoundField  DataField="RemoteMSE" meta:resourcekey="BoundFieldResource8"/>
                                  <asp:BoundField  DataField="RemoteRxPowerResult" meta:resourcekey="BoundFieldResource9"/>
                                  <asp:BoundField  DataField="RemoteMSEResult" meta:resourcekey="BoundFieldResource10"/>
                              </Columns>
                            </asp:GridView>        
                        </td>
                    </tr>
