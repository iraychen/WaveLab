<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCPullingForceEdit.aspx.cs" Inherits="WaveLab.Web.SPCPullingForceEdit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<center>
  <table style=" text-align:left ;"   width="700px" cellpadding="5">
   <tr>
   <td colspan="2">
      <fieldset>
             <table width="100%" class="form-table">
               <tr>
                    <td width="200px"><asp:Label ID="lblMachineNo" runat="server" 
                ...
                <tr>
                    ...
                    <td>
                         <asp:Literal ID="ltlWorkingDate" runat="server" 
                             meta:resourcekey="ltlWorkingDateResource1" />
                    </td>
		        </tr>
		        <tr>
                    ...
                    <td>
                       <asp:TextBox ID="tbxMWMType" runat="server" MaxLength="40" Width="150px" 
                 ...
                 <tr>
                    ...
                    <td>
                       <asp:TextBox ID="tbxMachinePressure" runat="server"  Width="150px" CssClass="mask_int" MaxLength="10"
                 ...
                 <tr>
                    ...
                    <td>
                       <asp:TextBox ID="tbxPowerFirstPoint" runat="server"  Width="150px" CssClass="mask_int" MaxLength="10"
                 ...
                 <tr>
                    ...
                    <td>
                       <asp:TextBox ID="tbxPowerSecondPoint" runat="server" Width="150px" CssClass="mask_int" MaxLength="10"
                 ...
                 <tr>
                    ...
                    <td>
                       <asp:TextBox ID="tbxOperator" runat="server" MaxLength="40" Width="150px" CssClass="mask_pnum"
