<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="IFBDataRangeCtl.aspx.cs" Inherits="WaveLab.Web.IFBDataRangeCtl" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key1,key2,key3)
{
    var url;
    switch(mode)
    {
        case "NEW":
            url = "IFBDataRangeNew.aspx?backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
            break;
        case "EDIT":
            url = "IFBDataRangeEdit.aspx?key1=" + key1 + "&key2=" + key2 + "&key3=" + key3 + "&backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
            break ;
        default:
            break;
    }
        ...
        <tr>
            <td>
                 <asp:GridView ID="GVList" runat="server" AllowSorting ="True"   AutoGenerateColumns="False"  
                    SkinID="skinGridView" Width ="100%" onrowdatabound="GVList_RowDataBound" DataKeyNames ="Data"
