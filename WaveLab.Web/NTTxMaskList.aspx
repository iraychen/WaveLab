<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTTxMaskList.aspx.cs" Inherits="WaveLab.Web.NTTxMaskList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="NTTxMaskView.aspx?NTTxMaskId="+value;
            break;
        default:
            break;
    }
