<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="MaterialTypeNew.aspx.cs" Inherits="WaveLab.Web.MaterialTypeNew" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
       ...
       <fieldset>
            <table  width="100%" class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="rblCalByQuantity" runat ="server" CssClass ="cl-table"   RepeatDirection="Horizontal" Width ="80"
