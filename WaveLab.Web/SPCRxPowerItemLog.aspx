<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCRxPowerItemLog.aspx.cs" Inherits="WaveLab.Web.SPCRxPowerItemLog" meta:resourcekey="PageResource1" %>
    ...
    <tr>
        ...
        <asp:GridView ID="GVList" runat="server" AllowSorting ="True"   AutoGenerateColumns="False"  
            ...
            meta:resourcekey="GVListResource1" >
              <Columns>
                  <asp:BoundField  DataField="LSL"   DataFormatString="{0:f2}"
