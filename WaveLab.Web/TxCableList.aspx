<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="TxCableList.aspx.cs" Inherits="WaveLab.Web.TxCableList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="TxCableView.aspx?TxCableId="+value;
            break;
        default:
            break;
    }
		...
		<td>
	      <asp:GridView ID="GVList" runat="server" AllowSorting ="True"  SkinId="skinGridView"
              ...
              <Columns>
                  ...
                  <asp:BoundField  DataField="StationNo" SortExpression ="a.station_no" meta:resourcekey="BoundFieldResource3"/>
                  <asp:BoundField  DataField="CHNo" SortExpression ="a.ch_no" meta:resourcekey="BoundFieldResource4"/>
                  <asp:BoundField  DataField="WGNo" SortExpression ="a.wg_no" meta:resourcekey="BoundFieldResource5"/>
                
                  <asp:BoundField  DataField="EndTime" SortExpression ="a.end_time" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" 
                        meta:resourcekey="BoundFieldResource6"/>
                    <asp:BoundField  DataField="RunningTime" SortExpression ="a.end_time" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" 
