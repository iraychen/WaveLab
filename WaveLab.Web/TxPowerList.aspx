<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="TxPowerList.aspx.cs" Inherits="WaveLab.Web.TxPowerList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="TxPowerView.aspx?TxPowerId="+value;
            break;
        default:
            break;
    }
