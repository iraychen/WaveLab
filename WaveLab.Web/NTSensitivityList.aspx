<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTSensitivityList.aspx.cs" Inherits="WaveLab.Web.NTSensitivityList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="NTSensitivityView.aspx?NTSensitivityId="+value;
            break;
        default:
            break;
    }
