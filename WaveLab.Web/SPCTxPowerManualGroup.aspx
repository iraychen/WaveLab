<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCTxPowerManualGroup.aspx.cs" Inherits="WaveLab.Web.SPCTxPowerManualGroup" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
     ...
     $(document).ready(function() {
         ...
         $("#<%=chxAutoInputTarget.ClientID%>").bind("click", function() {
             if ($(this).attr("checked") == true) {
                 $("#<%=tblLSL_USL.ClientID%>").hide();
             } else {
                 $("#<%=tblLSL_USL.ClientID%>").show();
             }
         });
     });
...
function formSubmit() {
    if ($("#<%=chxAutoInputTarget.ClientID%>").attr("checked") == false) {
        ...
        if ($.trim(usl.val()).length == 0 && $.trim(lsl.val()).length == 0) {
            alert($("#<%=lblDataRangeMsg.ClientID %>").attr("title"));
            return false;
        } else {
            var reg = /^[+-]?[0-9]+.?[0-9]*$/; ;
            if (($.trim(lsl.val()).length > 0 && reg.test($.trim(lsl.val())) == false) || ($.trim(usl.val()).length > 0 && reg.test($.trim(usl.val())) == false)) {
                            ...
                            <div style ="height:300px; overflow-x:hidden;overflow-y:auto; border:solid 1px #aaaaaa; text-align:left;">
                                <asp:GridView ID="GVItems" runat="server" AllowSorting ="True"  SkinId="skinGridView"
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField  DataField="OutPutPower" SortExpression ="b.output_power"
	            ...
	            <tr>
	                <td>
	                  <table id="tblGrouping" runat ="server" visible ="False" style ="width:100%">
	                    <tr runat="server">
	                        <td runat="server"><asp:Label ID ="lblItemsCount" runat ="server" 
                                        ...
                                        <td>
                                            <asp:TextBox ID="tbxGroupingNo" runat ="server"  Text="5"
                                             ...
                                             <ajaxToolkit:NumericUpDownExtender ID="NumericUpDownExtender1" runat="server"
                                                ...
                                                Width="100"
                                                Minimum = "2"
                                                Maximum = "10" Enabled="True" RefValues="" ServiceDownMethod="" 
		                    ...
		                    <div style ="height:300px; overflow-x:hidden;overflow-y:auto; border:solid 1px #aaaaaa; text-align:left;">
		                        <asp:GridView ID="GVGroupItems" runat="server" SkinId="skinGridView"
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField  DataField="OutPutPower"
                                            meta:resourcekey="BoundFieldResource3">
                                          <HeaderStyle Width="30%" />
                                      </asp:BoundField>
	                ...
	                <td>
	                    <table id ="tblSubmit"  runat ="server" visible ="False" style ="width:100%">
	                        <tr runat="server">
	                                     ...
	                                     <tr>
                                            ...
                                            <td>
	                                            <asp:TextBox ID ="tbxUCL_R" runat ="server" Width ="60px" 
		                                            meta:resourcekey="tbxUCL_R_Resource1"/>
	                            ...
	                            <td id="tblLSL_USL"  runat="server"  align="center">
	                                <fieldset>
	                                   <table>
	                                    <tr>
	                                        <td><asp:Label ID="lblLSL" runat ="server" meta:resourcekey="lblLSLResource1" /></td>
	                                        <td>
	                                            <asp:TextBox ID ="tbxLSL" runat ="server" Width ="60px" 
                                                    meta:resourcekey="tbxLSLResource1"/>
	                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilterExtLSL" ValidChars=".-" 
                                                    runat="server" FilterType ="Custom, Numbers" TargetControlID ="tbxLSL" 
                                                    Enabled="True" />	                               
	                                         </td>	                          
	                            ...
	                            <td align="right" style="white-space:nowrap" runat="server">
