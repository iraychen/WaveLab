<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCTxMaskFlatCompute.aspx.cs" Inherits="WaveLab.Web.SPCTxMaskFlatCompute" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function back() {
    self.location.href = '<%=Request.QueryString["backlink"] %>?1=1' + '&type=<%=Request.QueryString["type"] %>' + '&mode=<%=Request.QueryString["mode"] %>' + '&ch=<%=Request.QueryString["ch"] %>';
    return false;
}
