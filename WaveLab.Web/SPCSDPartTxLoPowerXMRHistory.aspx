<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartTxLoPowerXMRHistory.aspx.cs" Inherits="WaveLab.Web.SPCSDPartTxLoPowerXMRHistory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key) {
   ...
   switch (mode) {
       case "View":
           url = "SPCSDPartTxLoPowerXMRView.aspx?XMRPK=" + key;
           break;
       default:
           break;
   }
