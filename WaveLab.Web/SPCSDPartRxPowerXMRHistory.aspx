<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxPowerXMRHistory.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxPowerXMRHistory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key) {
   ...
   switch (mode) {
       case "View":
           url = "SPCSDPartRxPowerXMRView.aspx?XMRPK=" + key;
           break;
       default:
           break;
   }
