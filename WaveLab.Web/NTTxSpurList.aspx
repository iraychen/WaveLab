<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTTxSpurList.aspx.cs" Inherits="WaveLab.Web.NTTxSpurList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="NTTxSpurView.aspx?NTTxSpurId="+value;
            break;
        default:
            break;
    }
