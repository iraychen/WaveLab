<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQARxResultList.aspx.cs" Inherits="WaveLab.Web.FQARxResultList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="FQARxResultView.aspx?FQARxResultId="+value;
            break;
        default:
            break;
    }
		...
		<td>
		     <asp:GridView ID="GVList" runat="server" AllowSorting ="True"  SkinId="skinGridView"
                  ...
                  <asp:BoundField  DataField="Model" SortExpression ="c.model" 
                      ...
                      <asp:BoundField  DataField="CH" SortExpression ="a.ch" meta:resourcekey="BoundFieldResource3"/>
