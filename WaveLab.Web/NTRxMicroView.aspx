<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTRxMicroView.aspx.cs" Inherits="WaveLab.Web.NTRxMicroView" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                        ...
                        <td>
                            <asp:GridView ID="GVResult" runat="server" AllowSorting ="True"  SkinId="skinGridView"
                              ...
                              <Columns>
                                  ...
                                  <asp:BoundField  DataField="LocalRxPower" meta:resourcekey="BoundFieldResource3"/>
                                  <asp:BoundField  DataField="LocalSNR" meta:resourcekey="BoundFieldResource4"/>
                                  <asp:BoundField  DataField="LocalRxPowerResult" meta:resourcekey="BoundFieldResource5"/>
                                  <asp:BoundField  DataField="LocalSNRResult" meta:resourcekey="BoundFieldResource6"/>
                                   <asp:BoundField  DataField="LocalESResult" meta:resourcekey="BoundFieldResource7"/>
                                   <asp:BoundField  DataField="RemoteRxPower" meta:resourcekey="BoundFieldResource8"/>
                                  <asp:BoundField  DataField="RemoteSNR" meta:resourcekey="BoundFieldResource9"/>
                                  <asp:BoundField  DataField="RemoteRxPowerResult" meta:resourcekey="BoundFieldResource10"/>
                                  <asp:BoundField  DataField="RemoteSNRResult" meta:resourcekey="BoundFieldResource11"/>
                                   <asp:BoundField  DataField="RemoteESResult" meta:resourcekey="BoundFieldResource12"/>
                              </Columns>
                            </asp:GridView>        
                        </td>
                    </tr>
