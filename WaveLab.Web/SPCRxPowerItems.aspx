<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCRxPowerItems.aspx.cs" Inherits="WaveLab.Web.SPCRxPowerItems" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(popType,type,mode,ch,pw) {
   ...
   switch (popType) {
       case "GROUP":
           url = "SPCRxPowerManualGroup.aspx?type=" + type + "&mode=" + mode + "&ch=" + ch + "&pw=" + pw ;
           win = window.open(url, "secwin", strPara);
           break;
       case "APPENDITEM":
           url = "SPCRxPowerItemSelector.aspx?backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
           win = window.open(url, "secwin", strDialogPara);
           break;
       case "Edit":
           url = "SPCRxPowerItemEdit.aspx?RxPowerItemPK=" + type + "&backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
        ...
        <tr>
            <td>
                ...
                meta:resourcekey="GVListResource1" onsorting="GVList_Sorting" OnRowDeleting="GVList_RowDeleting">
                  <Columns>
                      <asp:BoundField  DataField="Type" SortExpression ="t.type"  
                            meta:resourcekey="BoundFieldResource1"/>
                      <asp:BoundField  DataField="Mode" SortExpression ="t.mode" 
                            meta:resourcekey="BoundFieldResource2"/>
                      <asp:BoundField  DataField="CH" SortExpression ="t.ch" 
                            meta:resourcekey="BoundFieldResource3"/>
                      <asp:BoundField  DataField="PW" SortExpression ="t.pw" 
                      ...
                      <asp:TemplateField meta:resourcekey="TemplateFieldResource2">
                        ...
                        <asp:LinkButton ID="lbtEdit" runat ="server"  meta:resourcekey="lbtEditResource1" />
                         &nbsp;
                        <asp:HiddenField ID="RxPowerItemPK" runat="server" />
