<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQATxSpurView.aspx.cs" Inherits="WaveLab.Web.FQATxSpurView" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<ajaxToolkit:TabPanel ID="TabPanel1" runat="server">
    ...
    <center>
         <table style="text-align:left;width:100%">
            ...
            <tr>
                <td>
                    <asp:Image ID="imgFQATxSpurResult" runat ="server" SkinID ="imgBlueArrow" />
                    <asp:Label ID="lblFQATxSpurResult" runat ="server"  Font-Bold ="True" Font-Size="12px"
                        meta:resourcekey="lblFQATxSpurResultResource1" />
                </td>
            </tr>
            <tr>
                <td>
                  <table width="100%" style ="text-align:left" >
                    <tr>
                        <td>
                             <asp:GridView ID="GVFQATxSpur" runat="server"  SkinId="skinGridView"
                                AutoGenerateColumns="False"  Width ="100%" EnableViewState ="False"
                                 meta:resourcekey="GVFQATxSpurResource1"  >
                              <Columns>
                                  <asp:BoundField  DataField="Mode"  meta:resourcekey="FQATxSpurBoundFieldResource1"/>
                                  <asp:BoundField  DataField="CH"  meta:resourcekey="FQATxSpurBoundFieldResource2"/>
                                  <asp:BoundField  DataField="FreqRange" meta:resourcekey="FQATxSpurBoundFieldResource3"/>
                                  <asp:BoundField  DataField="FreqPoint"  meta:resourcekey="FQATxSpurBoundFieldResource4"/>
                                  <asp:BoundField  DataField="SpurCheck"  meta:resourcekey="FQATxSpurBoundFieldResource5"/>
                              </Columns>
                             </asp:GridView>
                        </td>
                    </tr>
