<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SMTModelFileInduceIndex.aspx.cs" Inherits="WaveLab.Web.SMTModelFileInduceIndex" Title="无标题页"  meta:resourcekey="PageResource1"  %>
...
function redirect(mode,value)
{
    ...
    {
        case "New":
            url="SMTModelFileInduceNew.aspx?backlink="+$("#<%=hfdCurLink.ClientID %>").val();
            break;
        case "Edit":
            url="SMTModelFileInduceEdit.aspx?FileInducePK="+value+"&backlink="+$("#<%=hfdCurLink.ClientID %>").val();
            break ;
        case "Import":
            url = "SMTModelFileInduceImport.aspx?backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
            break;
        default:
            break;
    }
...
<table width ="99%" style="text-align:left" border ="0" cellpadding="0" cellspacing ="0">
   ...
   <tr style="height:30px">
        <td>
            <asp:LinkButton ID="lbtNew" runat="server"  Font-Bold="True" Text ="<%$ Resources:globalResource,CreateText %>" 
                            meta:resourcekey="lbtNewResource1" 
                OnClientClick ="return redirect('New','')" />           
            <font style="width:20px">|</font>
            <asp:LinkButton ID="lbtImport" runat="server" Font-Bold="True" OnClientClick ="return redirect('Import','')"
                    Text ="<%$ Resources:globalResource,ImportText %>" 
                    meta:resourcekey="lbtImportResource1"></asp:LinkButton>  
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <asp:GridView ID="GVList" runat="server" AllowSorting ="True"  
                ...
                AutoGenerateColumns="False"  Width ="100%" OnRowDeleting="GVList_RowDeleting"
                meta:resourcekey="GVListResource1" onrowdatabound="GVList_RowDataBound"
                onsorting="GVList_Sorting">
              <Columns>
                
                  <asp:TemplateField meta:resourcekey="TemplateFieldResource1"  HeaderStyle-Font-Size="11px" ItemStyle-Font-Size="11px" 
                  SortExpression ="a.module_type_id" HeaderStyle-Width="50"  >
                    <ItemTemplate>
                 ...
                 <asp:BoundField  DataField ="CoorPattern"  SortExpression ="CoorPattern"  HeaderStyle-Font-Size="11px" ItemStyle-Font-Size="11px" 
                  ...
                  <asp:TemplateField meta:resourcekey="TemplateFieldResource2"  SortExpression ="pcb"  HeaderStyle-Width="55"  HeaderStyle-Font-Size="11px" ItemStyle-Font-Size="11px" >
                    <ItemTemplate>
