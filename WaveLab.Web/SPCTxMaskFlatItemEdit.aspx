<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCTxMaskFlatItemEdit.aspx.cs" Inherits="WaveLab.Web.SPCTxMaskFlatItemEdit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <fieldset>
             <table style="width:580px">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><asp:Literal ID="ltlCH" runat ="server" meta:resourcekey="ltlCHResource1" /></td>
                    </tr>
                </table>
            </fieldset>
        </td>
