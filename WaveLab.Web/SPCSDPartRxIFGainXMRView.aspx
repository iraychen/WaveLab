<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxIFGainXMRView.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxIFGainXMRView" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
           ...
           <asp:Panel ID="ContentPanelItem" runat="server" BorderColor="Control" 
             ...
             <table style =" width:100%;" class ="setup-table">
                 <tr>
                    ...
                    <td>
                        <asp:Label ID="lblTxIndex" runat="server" 
                            meta:resourcekey="lblTxIndexResource1" />
                    </td>
                    <td>
                        <asp:Literal ID="ltlTxIndex" runat="server" 
                            meta:resourcekey="ltlTxIndexResource1" />
                    </td>
                      </tr>
                <tr>
