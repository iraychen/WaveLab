<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCRxPowerView.aspx.cs" Inherits="WaveLab.Web.SPCRxPowerView" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
              ...
              <fieldset>
                ...
                <table style ="width:100%;" class ="setup-table">
                    ...
                    <tr id="tblDoubleSide"  runat ="server">
                        <td><asp:Label ID="lblDoubleSideCP" runat="server" 
                                meta:resourcekey="lblDoubleSideCPResource1"/></td>
                        <td><asp:Literal ID ="ltlDoubleSideCP" runat ="server" 
                                meta:resourcekey="ltlDoubleSideCPResource1" /></td>
                        <td><asp:Label ID="lblDoubleSideCA" runat="server" 
                                meta:resourcekey="lblDoubleSideCAResource1"/></td>
                        <td><asp:Literal ID ="ltlDoubleSideCA" runat ="server" 
                                meta:resourcekey="ltlDoubleSideCAResource1" /></td>
                        <td><asp:Label ID="lblDoubleSideCPK" runat="server" 
                                meta:resourcekey="lblDoubleSideCPKResource1"/></td>
                        <td><asp:Literal ID ="ltlDoubleSideCPK" runat ="server" 
                                meta:resourcekey="ltlDoubleSideCPKResource1" /></td>
                    </tr>
                    <tr id="tblSingleSide"  runat ="server" >
                        <td style ="width:15%"><asp:Label ID="lblSingleSideCPU" runat="server" 
                                meta:resourcekey="lblSingleSideCPUResource1"/></td>
                        <td style ="width:20%"><asp:Literal ID ="ltlSingleSideCPU" runat ="server" 
                                meta:resourcekey="ltlSingleSideCPUResource1" /></td>
                        <td style ="width:15%"><asp:Label ID="lblSingleSideCPL" runat="server" 
                                meta:resourcekey="lblSingleSideCPLResource1"/></td>
                        <td style ="width:20%"><asp:Literal ID ="ltlSingleSideCPL" runat ="server" 
