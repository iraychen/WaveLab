<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="TxCalList.aspx.cs" Inherits="WaveLab.Web.TxCalList" Title="无标题页" culture="auto" meta:resourcekey="PageResource2" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="TxCalView.aspx?TxCalId="+value;
            break;
        default:
            break;
    }
