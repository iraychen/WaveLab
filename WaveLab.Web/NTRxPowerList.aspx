<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTRxPowerList.aspx.cs" Inherits="WaveLab.Web.NTRxPowerList" Title="无标题页" culture="auto" meta:resourcekey="PageResource2" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="NTRxPowerView.aspx?NTRxPowerId="+value;
            break;
        default:
            break;
    }
