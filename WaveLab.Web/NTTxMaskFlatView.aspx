<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTTxMaskFlatView.aspx.cs" Inherits="WaveLab.Web.NTTxMaskFlatView" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <center>
        <table style="text-align:left;width:100%">
            ...
            <table width="100%" style ="text-align:left" >
                 <tr>
                    <td>
                        <asp:Image ID="imgNTTxMaskFlatResult" runat ="server" SkinID ="imgBlueArrow" 
                            meta:resourcekey="imgNTTxMaskFlatResultResource1" />
                        <asp:Label ID="lblNTTxMaskFlatResult" runat ="server"  Font-Bold ="True" Font-Size="12px"
                            meta:resourcekey="lblNTTxMaskFlatResultResource1" />
                    </td>
                </tr>
                <tr>
                    <td>
                         <asp:GridView ID="GVNTTxMaskFlat" runat="server"  SkinId="skinGridView"
                            AutoGenerateColumns="False"  Width ="100%"  EnableViewState ="False"
                             meta:resourcekey="GVNTTxMaskFlatResource1"  >
                          <Columns>
                              <asp:BoundField  DataField="Mode"  meta:resourcekey="NTTxMaskFlatBoundFieldResource1"/>
                              <asp:BoundField  DataField="CH"  meta:resourcekey="NTTxMaskFlatBoundFieldResource2"/>
                              <asp:BoundField  DataField="MaskFlat"  meta:resourcekey="NTTxMaskFlatBoundFieldResource3"/>
                          </Columns>
                         </asp:GridView>  
                    </td>
                </tr>
