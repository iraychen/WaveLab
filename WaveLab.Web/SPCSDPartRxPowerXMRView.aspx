<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxPowerXMRView.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxPowerXMRView" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
           ...
           <asp:Panel ID="ContentPanelItem" runat="server" BorderColor="Control" 
             ...
             <table style =" width:100%;" class ="setup-table">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="ltlMode" runat="server" 
                            meta:resourcekey="ltlModeResource1" />
                    </td>
                   <td>
