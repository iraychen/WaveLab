<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQATxMaskFlatList.aspx.cs" Inherits="WaveLab.Web.FQATxMaskFlatList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="FQATxMaskFlatView.aspx?FQATxMaskFlatId="+value;
            break;
        default:
            break;
    }
