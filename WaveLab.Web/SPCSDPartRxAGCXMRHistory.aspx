<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxAGCXMRHistory.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxAGCXMRHistory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key) {
   ...
   switch (mode) {
       case "View":
           url = "SPCSDPartRxAGCXMRView.aspx?XMRPK=" + key;
           break;
       default:
           break;
   }
