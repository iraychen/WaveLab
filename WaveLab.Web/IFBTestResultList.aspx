<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="IFBTestResultList.aspx.cs" Inherits="WaveLab.Web.IFBTestResultList" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    var url;
    var win;
    var strPara="toolbar=0,status=0,scrollbars=1,resizable=1,width=700px,Height=500px";
    switch(mode)
    {
        case "VIEW":
            url = "IFBTestResultView.aspx?IFBTestResultId=" + value;
            break;
        default:
            break;
    }
		...
		<td>
            ...
            meta:resourcekey="GVListResource1" onsorting="GVList_Sorting" >
              <Columns>
                  ...
                  <asp:BoundField  DataField="IFFrequency" SortExpression ="if_frequency" meta:resourcekey="BoundFieldResource2"/>
