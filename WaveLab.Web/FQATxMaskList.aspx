<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQATxMaskList.aspx.cs" Inherits="WaveLab.Web.FQATxMaskList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="FQATxMaskView.aspx?FQATxMaskId="+value;
            break;
        default:
            break;
    }
