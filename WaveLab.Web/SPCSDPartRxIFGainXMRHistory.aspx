<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxIFGainXMRHistory.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxIFGainXMRHistory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key) {
   ...
   switch (mode) {
       case "View":
           url = "SPCSDPartRxIFGainXMRView.aspx?XMRPK=" + key;
           break;
       default:
           break;
   }
