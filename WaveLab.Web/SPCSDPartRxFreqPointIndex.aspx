<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxFreqPointIndex.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxFreqPointIndex" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,stationProjectPK)
{
    ...
    switch (mode) {
        case "Create":
            url = "SPCSDPartRxFreqPointCreate.aspx?backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
            paras = "toolbar=0,status=0,scrollbars=1,resizable=1,width=800px,Height=600px";
            break;
        case "Edit":
            url = "SPCSDPartRxFreqPointEdit.aspx?SDPartPK=" + stationProjectPK + "&backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
                    ...
                    <td>
                        <table style =" width:100%">
                          ...
                          <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tbxCH" runat="server" Width="180px"  meta:resourcekey="tbxCHResource1" ></asp:TextBox>
                            </td>
                            <td>
