<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCTxPowerItemSelector.aspx.cs" Inherits="WaveLab.Web.SPCTxPowerItemSelector" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                       ...
                       <td>
                             <table  class="form-table"> 
	                            ...
	                            <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID ="tbxLSL" runat ="server"     Width="200px" CssClass="mask_pnum" MaxLength="10"
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID ="tbxUSL" runat ="server"     Width="200px" CssClass="mask_pnum" MaxLength="10"
