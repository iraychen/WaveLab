<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="MAMDataRangeNew.aspx.cs" Inherits="WaveLab.Web.MAMDataRangeNew" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function verify()
{
    var MAMType = $("#<%=ddlMAMType.ClientID %>");
    var Data=$("#<%=tbxData.ClientID %>");
    if ($.trim(MAMType.val()).length == 0)
    {
        alert($("#<%=lblMAMTypeMsg.ClientID %>").attr("title"));
        MAMType.focus();
        return false;
    }
    if ($.trim(Data.val()).length == 0)
    {
        alert($("#<%=lblDataMsg.ClientID %>").attr("title"));
        Data.focus();
        return false;
    }
       ...
       <td>
          <fieldset>
             <table width="100%" class="form-table">
                <tr>
                    <td><asp:Label ID="lblMAMType" runat="server"  ForeColor ="Red" 
                            meta:resourcekey="lblMAMTypeResource1"/></td>
                    <td>
                       <asp:DropDownList ID ="ddlMAMType" runat ="server"  Width="150"
                            meta:resourcekey="ddlMAMTypeResource1"/>
                        <asp:Label ID ="lblMAMTypeMsg" runat ="server" 
                            meta:resourcekey="lblMAMTypeMsgResource1" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID ="tbxData" runat="server"  Width="400px" 
                            meta:resourcekey="tbxDataResource1"/>
                        <asp:Label ID="lblDataMsg" runat ="server" 
                            meta:resourcekey="lblDataMsgResource1" />
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <asp:GridView ID="GVList" runat="server"   GridLines ="None"  SkinID="skinGridView"
              ...
              <Columns>
                <asp:TemplateField meta:resourcekey="TemplateFieldResource1" >
                    <HeaderTemplate >
                        <input type ="checkbox" id="allCheckBox" OnClick='JavaScript:allCheck()' checked ="checked" />
                 ...
                 <asp:TemplateField meta:resourcekey="TemplateFieldResource2" >
                    <ItemTemplate>
                        <asp:Literal ID="ltlFrequency" runat ="server"   Text='<%#Eval("Frequency") %>'/>
                    </ItemTemplate>
                 </asp:TemplateField>
