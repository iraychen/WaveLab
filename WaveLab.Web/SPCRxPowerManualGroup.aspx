<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCRxPowerManualGroup.aspx.cs" Inherits="WaveLab.Web.SPCRxPowerManualGroup" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                            ...
                            <div style ="height:300px; overflow-x:hidden;overflow-y:auto; border:solid 1px #aaaaaa; text-align:left;">
                                <asp:GridView ID="GVItems" runat="server" AllowSorting ="True"  SkinId="skinGridView"
                                  ...
                                  <Columns>
                                      ...
                                      <asp:BoundField  DataField="Val" SortExpression ="b.receive_result"
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td>
		                                        <asp:TextBox ID ="tbxLCL_X" runat ="server" Width ="60px" 
			                                        meta:resourcekey="tbxLCL_X_Resource1"/>
	                                     ...
	                                     <tr>
                                            ...
                                            <td>
	                                            <asp:TextBox ID ="tbxLCL_R" runat ="server" Width ="60px" 
		                                            meta:resourcekey="tbxLCL_R_Resource1"/>
