<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SYSMenuNew.aspx.cs" Inherits="WaveLab.Web.SYSMenuNew" Title="无标题页"  meta:resourcekey="PageResource1"  %>
   ...
   <tr>
    <td align ="right">
      ...
      <asp:NewButton ID="btnSave" runat="server"  Width ="80"   Text ="<%$ Resources:globalResource,SaveText %>"
            Action ="MenuNew" OnClientClick="return verify()" onclick="btnSave_Click"/>
      &nbsp;
