<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="MAMTestResultList.aspx.cs" Inherits="WaveLab.Web.MAMTestResultList" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function formClear() {
    ...
    $("#<%=tbxMBSerialNo.ClientID %>").val("");
    $("#<%=tbxPllSerialNo.ClientID %>").val("");
...
function makeWindow(mode,value)
{
    var url;
    var win;
    var strPara="toolbar=0,status=0,scrollbars=1,resizable=1,width=800px,Height=600px";
    switch(mode)
    {
        case "VIEW":
            url = "MAMTestResultView.aspx?MAMTestResultId=" + value;
            break;
        default:
            break;
    }
                ...
                <tr>
                    <td>
                         <table style =" width:100%">
                            ...
                            <tr>
                                <td><asp:Label ID="lblMBSerialNo" runat="server" meta:resourcekey="lblMBSerialNoResource1"/></td>
                                <td>
                                    <asp:TextBox ID="tbxMBSerialNo" runat="server"  Width="200px" 
                                        meta:resourcekey="tbxMBSerialNoResource1"/>
                                </td>
                                <td><asp:Label ID="lblPllSerialNo" runat="server" meta:resourcekey="lblPllSerialNoResource1"/></td>
                                <td>
                                    <asp:TextBox ID="tbxPllSerialNo" runat="server"  Width="200px" 
                                        meta:resourcekey="tbxPllSerialNoResource1"/>
                                </td>
                             </tr>
                             <tr>
                                 <td >
            ...
            meta:resourcekey="GVListResource1" onsorting="GVList_Sorting" >
              <Columns>
                  ...
                  <asp:TemplateField meta:resourcekey="TemplateFieldResource1" SortExpression ="a.serial_no">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtMBSerialNo" runat ="server" meta:resourcekey="lbtMBSerialNoResource1"/>
                    </ItemTemplate>
                  </asp:TemplateField>
                  <asp:BoundField  DataField="PLLSerialNo" SortExpression ="pll_serial_no" meta:resourcekey="BoundFieldResource2"/>
                  <asp:BoundField  DataField="IFFrequency" SortExpression ="if_frequency" meta:resourcekey="BoundFieldResource3"/>
                  <asp:BoundField  DataField="REVMainBoard" SortExpression ="rev_mainboard" meta:resourcekey="BoundFieldResource4"/>
                  <asp:BoundField  DataField="REVPLLBoard" SortExpression ="rev_pllboard" meta:resourcekey="BoundFieldResource5"/>
                  <asp:BoundField  DataField="StationNo" SortExpression ="station_no" meta:resourcekey="BoundFieldResource6"/>
                  <asp:BoundField  DataField="EndTime" SortExpression ="end_time" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" 
                        meta:resourcekey="BoundFieldResource7"/>
                  <asp:BoundField  DataField="AppVersion" SortExpression ="app_version" meta:resourcekey="BoundFieldResource8"/>
