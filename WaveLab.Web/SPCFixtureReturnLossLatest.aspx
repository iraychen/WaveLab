<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCFixtureReturnLossLatest.aspx.cs" Inherits="WaveLab.Web.SPCFixtureReturnLossLatest" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<ajaxToolkit:TabContainer ID="TabContainer1" runat="server" 
    ...
    <ajaxToolkit:TabPanel ID="TabPanelReturnLoss" runat="server" meta:resourcekey="TabPanelReturnLossResource1">
        <HeaderTemplate>
            <asp:Label ID="lblReturnLoss" runat ="server"   meta:resourcekey="lblReturnLossResource1"></asp:Label>
        </HeaderTemplate>
        <ContentTemplate>
        <table width ="100%">
     <tr>
...
<ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelChartX" runat="server"
 ...
 <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelChartR" runat="server"
    ...
    <ajaxToolkit:TabPanel ID="TabPanelInsertionLoss" runat="server"
        ...
        <HeaderTemplate>
            <asp:LinkButton ID="lbtInsertionLoss" runat ="server"  onclick="lbtInsertionLoss_Click"
            meta:resourcekey="lbtInsertionLossResource1" />
        </HeaderTemplate>
        <ContentTemplate>
    </ContentTemplate>
    </ajaxToolkit:TabPanel> 
