<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="MIMeasureDataEdit.aspx.cs" Inherits="WaveLab.Web.MIMeasureDataEdit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                ...
                <tr>
                    ...
                    <td rowspan ="2">
                        <asp:RadioButtonList ID="rblRSSIFinalFlag" runat ="server"   CssClass="cl-table">
                           ...
                           <asp:ListItem  meta:resourcekey="ListItemResource8" />
                        </asp:RadioButtonList>
                    </td>
                    <td rowspan ="2">
