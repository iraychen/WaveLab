<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="RxResultList.aspx.cs" Inherits="WaveLab.Web.RxResultList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    var url;
    var win;
    var strPara="toolbar=0,status=0,scrollbars=1,resizable=1,width=750px,Height=580px";
    switch(mode)
    {
        case "VIEW":
            url = "RxResultView.aspx?RxResultId=" + value;
            break;
        default:
            break;
    }
   ...
   <tr>
	...
	<tr>
		<td>
            ...
            AutoGenerateColumns="False"  Width ="100%" EnableViewState ="False" onrowdatabound="GVList_RowDataBound"
          ...
          <Columns>
           ...
           <%--   <asp:BoundField  DataField="Channel" SortExpression ="a.channel" meta:resourcekey="BoundFieldResource3"/>--%>
                  <asp:BoundField  DataField="StationNo" SortExpression ="a.station_no" meta:resourcekey="BoundFieldResource4"/>
               <%--   <asp:BoundField  DataField="CHNo" SortExpression ="a.ch_no" meta:resourcekey="BoundFieldResource5"/>
                  <asp:BoundField  DataField="WGNo" SortExpression ="a.wg_no" meta:resourcekey="BoundFieldResource6"/>--%>
                  <asp:BoundField  DataField="EndTime" SortExpression ="a.end_time" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" 
                        meta:resourcekey="BoundFieldResource7"/>
                  <asp:BoundField  DataField="RunningTime" SortExpression ="a.end_time"  
                        meta:resourcekey="BoundFieldResource8"/>
                  <asp:BoundField  DataField="AppVersion" SortExpression ="a.app_version" 
