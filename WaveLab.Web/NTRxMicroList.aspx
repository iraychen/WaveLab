<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTRxMicroList.aspx.cs" Inherits="WaveLab.Web.NTRxMicroList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    var url;
    var win;
    var strPara="toolbar=0,status=0,scrollbars=1,resizable=1,width=780px,Height=580px";
    switch(mode)
    {
        case "VIEW":
            url = "NTRxMicroView.aspx?NTRxMicroPK=" + value;
            break;
        default:
            break;
    }
