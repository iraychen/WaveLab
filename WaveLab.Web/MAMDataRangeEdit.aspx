<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="MAMDataRangeEdit.aspx.cs" Inherits="WaveLab.Web.MAMDataRangeEdit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
          ...
          <fieldset>
             <table width="100%" class="form-table">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="ltlMAMType" runat ="server" 
                            meta:resourcekey="ltlMAMTypeResource1" />
                    </td>
                </tr>
                <tr>
                    <td>
