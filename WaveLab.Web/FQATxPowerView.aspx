<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQATxPowerView.aspx.cs" Inherits="WaveLab.Web.FQATxPowerView" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <table width="100%" style ="text-align:left" >
           <tr>
            ...
            <tr>
                <td>
                    <table cellpadding="3" cellspacing="0"   style="text-align:left; width:100%" class="setup-table">
                         ...
                         <tr>
                             <td style ="width:200px"><asp:Label id ="lblModel" runat ="server"  Font-Bold ="True"
            ...
            <td><asp:Literal id ="ltlReason" runat ="server" 
             ...
             <tr>
                <td>
                    <asp:Image ID="imgFQATxPowerResult" runat ="server" SkinID ="imgBlueArrow" />
                    <asp:Label ID="lblFQATxPowerResult" runat ="server"  Font-Bold ="true" Font-Size="12px"
                        meta:resourcekey="lblFQATxPowerResultResource1" />
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <tr>
                        <td>
                            <asp:ListView ID="LVResult"  runat="server"  
                                ...
                                <LayoutTemplate>
                                    <table  class="setup-table" cellpadding="0" cellspacing="0" width="100%">
                                        <tr >
