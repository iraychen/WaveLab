<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="ProtocolInitialList.aspx.cs" Inherits="WaveLab.Web.ProtocolInitialList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="ProtocolInitialView.aspx?ProtocolInitId="+value;
            break;
        default:
            break;
    }
