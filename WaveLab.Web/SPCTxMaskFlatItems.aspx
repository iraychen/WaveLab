<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCTxMaskFlatItems.aspx.cs" Inherits="WaveLab.Web.SPCTxMaskFlatItems" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(popType,type,mode,ch,pw) {
   ...
   switch (popType) {
       case "GROUP":
           url = "SPCTxMaskFlatManualGroup.aspx?type=" + type + "&mode=" + mode + "&ch=" + ch;
           win = window.open(url, "secwin", strPara);
           break;
       case "APPENDITEM":
           url = "SPCTxMaskFlatItemSelector.aspx?backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
           win = window.open(url, "secwin", strDialogPara);
           break;
       case "Edit":
           url = "SPCTxMaskFlatItemEdit.aspx?TxMaskFlatItemPK=" + type + "&backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
                  ...
                  <Columns>
                      ...
                      <asp:TemplateField meta:resourcekey="TemplateFieldResource2">
                        ...
                        <asp:LinkButton ID="lbtEdit" runat ="server"  meta:resourcekey="lbtEditResource1" />
                         &nbsp;
                        <asp:HiddenField ID="TxMaskFlatItemPK" runat="server" />
