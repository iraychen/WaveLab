<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCRxPowerAutoGroup.aspx.cs" Inherits="WaveLab.Web.SPCRxPowerAutoGroup" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<script type ="text/javascript">
    ...
    function makeWindow(popType, PK, groupNo) {
        ...
        switch (popType) {
            case "ORIGINAL":
                url = "SPCRxPowerDetail.aspx?PK=" + PK + "&groupno=" + groupNo;
                break;
            default:
                break;
        }
                          ...
                          <fieldset>
                            ...
                            <table style ="width:100%;" class ="setup-table">
                                ...
                                <tr id="tblDoubleSide"  runat ="server">
                                    <td id="Td1" runat="server"><asp:Label ID="lblDoubleSideCP" runat="server" 
                                            meta:resourcekey="lblDoubleSideCPResource1"/></td>
                                    <td id="Td2" runat="server"><asp:Literal ID ="ltlDoubleSideCP" runat ="server" 
                                            meta:resourcekey="ltlDoubleSideCPResource1" /></td>
                                    <td id="Td3" runat="server"><asp:Label ID="lblDoubleSideCA" runat="server" 
                                            meta:resourcekey="lblDoubleSideCAResource1"/></td>
                                    <td id="Td4" runat="server"><asp:Literal ID ="ltlDoubleSideCA" runat ="server" 
                                            meta:resourcekey="ltlDoubleSideCAResource1" /></td>
                                    <td id="Td5" runat="server"><asp:Label ID="lblDoubleSideCPK" runat="server" 
                                            meta:resourcekey="lblDoubleSideCPKResource1"/></td>
                                    <td id="Td6" runat="server"><asp:Literal ID ="ltlDoubleSideCPK" runat ="server" 
                                            meta:resourcekey="ltlDoubleSideCPKResource1" /></td>
                                </tr>
                                <tr id="tblSingleSide"  runat ="server" >
                                    <td id="Td7" style ="width:15%" runat="server"><asp:Label ID="lblSingleSideCPU" runat="server" 
                                            meta:resourcekey="lblSingleSideCPUResource1"/></td>
                                    <td id="Td8" style ="width:20%" runat="server"><asp:Literal ID ="ltlSingleSideCPU" runat ="server" 
                                            meta:resourcekey="ltlSingleSideCPUResource1" /></td>
                                    <td id="Td9" style ="width:15%" runat="server"><asp:Label ID="lblSingleSideCPL" runat="server" 
                                            meta:resourcekey="lblSingleSideCPLResource1"/></td>
                                    <td id="Td10" style ="width:20%" runat="server"><asp:Literal ID ="ltlSingleSideCPL" runat ="server" 
                                            meta:resourcekey="ltlSingleSideCPLResource1" /></td>
                                    <td id="Td11" style ="width:15%" runat="server"><asp:Label ID="lblSingleSideCPK" runat="server" 
                                            meta:resourcekey="lblSingleSideCPKResource1"/></td>
                                    <td id="Td12" style ="width:15%" runat="server"><asp:Literal ID ="ltlSingleSideCPK" runat ="server" 
