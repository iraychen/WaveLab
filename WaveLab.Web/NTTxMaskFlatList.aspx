<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTTxMaskFlatList.aspx.cs" Inherits="WaveLab.Web.NTTxMaskFlatList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="NTTxMaskFlatView.aspx?NTTxMaskFlatId="+value;
            break;
        default:
            break;
    }
