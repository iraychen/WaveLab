<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCTxPowerList.aspx.cs" Inherits="WaveLab.Web.SPCTxPowerList" culture="auto" meta:resourcekey="PageResource2" uiculture="auto" %>
        ...
        <tr>
            <td>
                 <asp:GridView ID="GVList" runat="server" AllowSorting ="True"   AutoGenerateColumns="False"  
                    SkinID="skinGridView" Width ="100%" onrowdatabound="GVList_RowDataBound" DataKeyNames="TxPowerPK"
