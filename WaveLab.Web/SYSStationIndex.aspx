<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SYSStationIndex.aspx.cs" Inherits="WaveLab.Web.SYSStationIndex" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key)
{
    ...
    switch (mode) {
        case "Create":
            url = "SYSStationCreate.aspx?backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
            paras = "toolbar=0,status=0,scrollbars=1,resizable=0,width=700px,Height=500px";
            break;
        case "Edit":
            url = "SYSStationEdit.aspx?StationNo=" + key + "&backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
            paras = "toolbar=0,status=0,scrollbars=1,resizable=0,width=700px,Height=500px";
            break; 
        default:
            break;
...
<table width ="99%" style="text-align:left" border ="0" cellpadding="0" cellspacing ="0">
    ...
    <tr>
        <td>
             <asp:GridView ID="GVList" runat="server" AllowSorting ="True"   AutoGenerateColumns="False"  DataKeyNames="StationNo"
              ...
              <Columns>
                  <asp:BoundField  DataField="StationNo" SortExpression ="Station_No" meta:resourcekey="BoundFieldResource1"/>
                  <asp:BoundField  DataField="Position" SortExpression ="Position" meta:resourcekey="BoundFieldResource2"/> 
