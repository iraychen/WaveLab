<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQATxMaskFlatView.aspx.cs" Inherits="WaveLab.Web.FQATxMaskFlatView" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <center>
        <table style="text-align:left;width:100%">
            ...
            <table width="100%" style ="text-align:left" >
                 <tr>
                    <td>
                        <asp:Image ID="imgFQATxMaskFlatResult" runat ="server" SkinID ="imgBlueArrow" 
                            meta:resourcekey="imgFQATxMaskFlatResultResource1" />
                        <asp:Label ID="lblFQATxMaskFlatResult" runat ="server"  Font-Bold ="True" Font-Size="12px"
                            meta:resourcekey="lblFQATxMaskFlatResultResource1" />
                    </td>
                </tr>
                <tr>
                    <td>
                         <asp:GridView ID="GVFQATxMaskFlat" runat="server"  SkinId="skinGridView"
                            AutoGenerateColumns="False"  Width ="100%"  EnableViewState ="False"
                             meta:resourcekey="GVFQATxMaskFlatResource1"  >
                          <Columns>
                              <asp:BoundField  DataField="Mode"  meta:resourcekey="FQATxMaskFlatBoundFieldResource1"/>
                              <asp:BoundField  DataField="CH"  meta:resourcekey="FQATxMaskFlatBoundFieldResource2"/>
                              <asp:BoundField  DataField="MaskFlat"  meta:resourcekey="FQATxMaskFlatBoundFieldResource3"/>
                          </Columns>
                         </asp:GridView>  
                    </td>
                </tr>
