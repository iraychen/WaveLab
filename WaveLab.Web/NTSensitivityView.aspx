<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTSensitivityView.aspx.cs" Inherits="WaveLab.Web.NTSensitivityView" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <table width="100%" style ="text-align:left" >
           <tr>
            ...
            <tr>
             ...
             <tr>
                <td>
                    <asp:Image ID="imgSensitivity" runat ="server" SkinID ="imgBlueArrow" 
                        meta:resourcekey="imgSensitivityResource1" />
                    <asp:Label ID="lblSensitivity" runat ="server"  Font-Bold ="True" Font-Size="12px"
                        meta:resourcekey="lblSensitivityResource1" />
                </td>
            </tr>
            <tr>
                <td>
                   <table style ="width:100%; text-align:left" cellspacing="0">
                    <tr>
                        <td>
                            <asp:GridView ID="GVNTSensitivity" runat="server"  SkinId="skinGridView"
                                AutoGenerateColumns="False"  Width ="100%" EnableViewState ="False"
                                 meta:resourcekey="GVNTSensitivityResource1"  >
                              <Columns>
                                  <asp:BoundField  DataField="Mode"  meta:resourcekey="NTSensitivityBoundFieldResource1"/>
                                  <asp:BoundField  DataField="CH" meta:resourcekey="NTSensitivityBoundFieldResource2"/>
                                  <asp:BoundField  DataField="UpperLimit" meta:resourcekey="NTSensitivityBoundFieldResource3"/>
                                  <asp:BoundField  DataField="UpperResult"   meta:resourcekey="NTSensitivityBoundFieldResource4"/>
                                  <asp:BoundField  DataField="LowerLimit"  meta:resourcekey="NTSensitivityBoundFieldResource5"/>
                                  <asp:BoundField  DataField="LowerResult"  meta:resourcekey="NTSensitivityBoundFieldResource6"/>
                              </Columns>
                            </asp:GridView>  
                        </td>
                    </tr>
