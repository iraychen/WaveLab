<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxFreqPointXMRHistory.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxFreqPointXMRHistory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key) {
   ...
   switch (mode) {
       case "View":
           url = "SPCSDPartRxFreqPointXMRView.aspx?XMRPK=" + key;
           break;
       default:
           break;
   }
