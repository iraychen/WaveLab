<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SMTPCBSteelMeshEdit.aspx.cs" Inherits="WaveLab.Web.SMTPCBSteelMeshEdit" Title="无标题页"  meta:resourcekey="PageResource1"  %>
                ...
                <tr>
                    ...
                    <td>
                       <asp:Label ID="lblPCBInfo" runat ="server" ForeColor ="Blue" 
                            meta:resourcekey="lblPCBInfoResource1" />
                    </td>
                </tr>
                <tr>
