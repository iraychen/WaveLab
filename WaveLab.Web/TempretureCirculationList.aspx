<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="TempretureCirculationList.aspx.cs" Inherits="WaveLab.Web.TempretureCirculationList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="TempretureCirculationView.aspx?TemcirculationId="+value;
            break;
        default:
            break;
    }
