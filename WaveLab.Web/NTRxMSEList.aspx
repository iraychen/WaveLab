<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="NTRxMSEList.aspx.cs" Inherits="WaveLab.Web.NTTxList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="NTRxMSEView.aspx?NTRxMSEId="+value;
            break;
        default:
            break;
    }
