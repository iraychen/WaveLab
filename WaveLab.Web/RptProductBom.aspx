<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="RptProductBom.aspx.cs" Inherits="WaveLab.Web.RptProductBom" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<center>
    ...
    <table cellSpacing="0" cellPadding="20" border="1"   width ="400" style ="text-align:left">
        <tr>
            <td align ="center">
                   ...
                   <%-- <tr>
                        ...
                        <td>
                            <asp:DropDownList ID ="ddlExportType" runat ="server" 
                                ...
                                <asp:ListItem meta:resourcekey="ListItemResource1">Screen</asp:ListItem>
                                <asp:ListItem meta:resourcekey="ListItemResource2">Excel</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        </tr>--%>
                 </table>
