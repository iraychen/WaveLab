<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCTxMaskFlatList.aspx.cs" Inherits="WaveLab.Web.SPCTxMaskFlatList" culture="auto" meta:resourcekey="PageResource2" uiculture="auto" %>
...
function makeWindow(popType,TxMaskFlatPK) {
   var url;
   var win;
   var strPara = "toolbar=0,status=0,scrollbars=1,resizable=1,width=1000px,Height=700px";
   switch (popType) {
       case "VIEW":
           url = "SPCTxMaskFlatView.aspx?TxMaskFlatPK=" + TxMaskFlatPK;
           break;
       default:
           break;
   }
        ...
        <tr>
            <td>
                 <asp:GridView ID="GVList" runat="server" AllowSorting ="True"   AutoGenerateColumns="False"  
                    SkinID="skinGridView" Width ="100%" onrowdatabound="GVList_RowDataBound" DataKeyNames="TxMaskFlatPK"
