<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="FQATxPowerList.aspx.cs" Inherits="WaveLab.Web.FQATxPowerList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,value)
{
    ...
    {
        case "VIEW":
            url="FQATxPowerView.aspx?FQATxPowerId="+value;
            break;
        default:
            break;
    }
