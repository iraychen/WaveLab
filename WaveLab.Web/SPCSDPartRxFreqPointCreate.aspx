<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartRxFreqPointCreate.aspx.cs" Inherits="WaveLab.Web.SPCSDPartRxFreqPointCreate" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
   ...
   <td>
    ...
    <tr>
        ...
        <asp:GridView ID="GVList" runat="server" AllowSorting ="True"   AutoGenerateColumns="False"  
              SkinID="skinGridView"  Width ="100%"  DataKeyNames="StationNo,Divide,CHNo,CH,PW,SerialNo"
