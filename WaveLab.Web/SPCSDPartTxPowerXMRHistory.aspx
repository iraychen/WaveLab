<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartTxPowerXMRHistory.aspx.cs" Inherits="WaveLab.Web.SPCSDPartTxPowerXMRHistory" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,key) {
   ...
   switch (mode) {
       case "View":
           url = "SPCSDPartTxPowerXMRView.aspx?XMRPK=" + key;
           break;
       default:
           break;
   }
                        ...
                        <table style ="width:100%">
                         <tr>                                
                          ...
                          <tr>
                            ...
                            <td>
                              <asp:TextBox ID="tbxMode" runat="server"  Width="180px" 
                                    meta:resourcekey="tbxModeResource1"></asp:TextBox>
                            </td>
                            <td>
