<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="GeneralInitialList.aspx.cs" Inherits="WaveLab.Web.GeneralInitialList" Title="无标题页" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode, value) {
   ...
   switch (mode) {
       case "VIEW":
           url = "GeneralInitialView.aspx?GeneralInitId=" + value;
           break;
       default:
           break;
   }
                ...
                meta:resourcekey="GVListResource1" onsorting="GVList_Sorting" >
                  <Columns>
                     <asp:BoundField  DataField="Model" SortExpression ="c.model" 
                      ...
                      <asp:BoundField  DataField="AppVersion" SortExpression ="app_version" 
