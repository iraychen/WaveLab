<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCFixtureInsertionLossLatest.aspx.cs" Inherits="WaveLab.Web.SPCFixtureInsertionLossLatest" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<ajaxToolkit:TabContainer ID="TabContainer1" runat="server" 
        ...
        VerticalStripWidth="120px" meta:resourcekey="TabContainer1Resource1">
    <ajaxToolkit:TabPanel ID="TabPanelReturnLoss" runat="server" meta:resourcekey="TabPanelReturnLossResource1">
        <HeaderTemplate>
            <asp:LinkButton ID="lbtReturnLoss" runat ="server"  onclick="lbtReturnLoss_Click"
            meta:resourcekey="lbtReturnLossResource1" />
        </HeaderTemplate>
        <ContentTemplate></ContentTemplate>
    </ajaxToolkit:TabPanel>
    
    <ajaxToolkit:TabPanel ID="TabPanelInsertionLoss" runat="server"
        ScrollBars="Auto" meta:resourcekey="TabPanelInsertionLossResource1"  >
        <HeaderTemplate>
            <asp:Label ID="lblInsertionLoss" runat ="server"   meta:resourcekey="lblInsertionLossResource1"></asp:Label>
        </HeaderTemplate>
        <ContentTemplate>
