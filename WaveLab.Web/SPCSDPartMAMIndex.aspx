<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SPCSDPartMAMIndex.aspx.cs" Inherits="WaveLab.Web.SPCSDPartMAMIndex" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
function makeWindow(mode,stationProjectPK)
{
    ...
    switch (mode) {
        case "Create":
            url = "SPCSDPartMAMCreate.aspx?backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
            paras = "toolbar=0,status=0,scrollbars=1,resizable=1,width=800px,Height=600px";
            break;
        case "Edit":
            url = "SPCSDPartMAMEdit.aspx?SDPartPK=" + stationProjectPK + "&backlink=" + $("#<%=hfdCurLink.ClientID %>").val();
