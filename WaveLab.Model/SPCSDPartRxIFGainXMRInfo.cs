...
{
    public class SPCSDPartRxIFGainXMRInfo
    {
        private int _XMRPK;
        ...
        private IList<SPCSDPartRxIFGainDetail> _DetailItems;

        private IList<SPCSDPartRxIFGainException> _ExceptionItems;
        ...
        public IList<SPCSDPartRxIFGainDetail> DetailItems
        {
            get
            {
        ...
        public IList<SPCSDPartRxIFGainException> ExceptionItems
        {
            get
            {
