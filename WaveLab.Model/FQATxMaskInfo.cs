...
{
    public class FQATxMaskInfo
    {


        private string _Model;

        private int _FQATxMaskId;
        ...
        private IList<FQATxMaskDetailInfo> _FQATxMaskDetailItems;
        ...
        public IList<FQATxMaskDetailInfo> FQATxMaskDetailItems
        {
            get
            {
                return this._FQATxMaskDetailItems;
            }
            set
            {
                this._FQATxMaskDetailItems = value;
            }
        }
    }
}
