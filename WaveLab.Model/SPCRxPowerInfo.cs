...
namespace WaveLab.Model
{
    public class SPCRxPowerInfo
    {
        ...
        private IList<SPCRxPowerDetail> _OriginalItems;

        private IList<SPCRxPowerGroup> _GroupItems;

        private IList<SPCRxPowerException> _ExceptionItems;
        ...
        public IList<SPCRxPowerDetail> OriginalItems
        {
            get
            {
        ...
        public IList<SPCRxPowerGroup> GroupItems
        {
            get
            {
        ...
        public IList<SPCRxPowerException> ExceptionItems
        {
            get
            {
