...
{
    public class NTRxPowerInfo
    {
      
        private string _Model;

        private int _NTRxPowerId;
        ...
        private IList<NTRxPowerDetailIInfo> _NTRxPowerDetailItems;
        ...
        public IList<NTRxPowerDetailIInfo> NTRxPowerDetailItems
        {
            get
            {
                return this._NTRxPowerDetailItems;
            }
            set
            {
                this._NTRxPowerDetailItems = value;
            }
        }
    }
}
