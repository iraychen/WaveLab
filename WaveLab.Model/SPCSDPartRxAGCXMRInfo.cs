...
{
    public class SPCSDPartRxAGCXMRInfo
    {
        private int _XMRPK;
        ...
        private IList<SPCSDPartRxAGCDetail> _DetailItems;

        private IList<SPCSDPartRxAGCException> _ExceptionItems;
        ...
        public IList<SPCSDPartRxAGCDetail> DetailItems
        {
            get
            {
        ...
        public IList<SPCSDPartRxAGCException> ExceptionItems
        {
            get
            {
