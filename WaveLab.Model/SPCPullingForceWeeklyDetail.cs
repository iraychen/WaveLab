...
{
    public class SPCPullingForceWeeklyDetail
    {
        private int _PullingForceWeeklyDetailPK;
        ...
        public int PullingForceWeeklyDetailPK
        {
            get
            {
                return this._PullingForceWeeklyDetailPK;
            }
            set
            {
                this._PullingForceWeeklyDetailPK = value;
            }
        }
