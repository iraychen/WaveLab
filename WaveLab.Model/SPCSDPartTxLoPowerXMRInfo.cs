...
{
    public class SPCSDPartTxLoPowerXMRInfo
    {
        private int _XMRPK;
        ...
        private IList<SPCSDPartTxLoPowerDetail> _DetailItems;

        private IList<SPCSDPartTxLoPowerException> _ExceptionItems;
        ...
        public IList<SPCSDPartTxLoPowerDetail> DetailItems
        {
            get
            {
        ...
        public IList<SPCSDPartTxLoPowerException> ExceptionItems
        {
            get
            {
