...
{
    public class SPCFixtureReturnLossInfo
    {
        private int _ReturnLossPK;
        ...
        private IList<SPCFixtureReturnLossDetail> _DetailItems;

        private IList<SPCFixtureReturnLossException> _ExceptionItems;

        private System.DateTime _LastUpdateDate;

        private string _LastUpdatedBy;

        public int ReturnLossPK
        {
            get
            {
                return this._ReturnLossPK;
            }
            set
            {
                this._ReturnLossPK = value;
            }
        }
        ...
        public IList<SPCFixtureReturnLossDetail> DetailItems
        {
            get
            {
        ...
        public IList<SPCFixtureReturnLossException> ExceptionItems
        {
            get
            {
