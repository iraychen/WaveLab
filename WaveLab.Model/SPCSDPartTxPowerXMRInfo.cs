...
{
    public class SPCSDPartTxPowerXMRInfo
    {
        private int _XMRPK;
        ...
        private IList<SPCSDPartTxPowerDetail> _DetailItems;

        private IList<SPCSDPartTxPowerException> _ExceptionItems;
        ...
        public IList<SPCSDPartTxPowerDetail> DetailItems
        {
            get
            {
        ...
        public IList<SPCSDPartTxPowerException> ExceptionItems
        {
            get
            {
