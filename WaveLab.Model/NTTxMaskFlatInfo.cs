...
{
    public class NTTxMaskFlatInfo
    {
      
        private int _NTTxMaskFlatId;
        ...
        private IList<NTTxMaskFlatDetailInfo> _NTTxMaskFlatDetailItems;

      

        public int NTTxMaskFlatId
        {
            get
            {
        ...
        public IList<NTTxMaskFlatDetailInfo> NTTxMaskFlatDetailItems
        {
            get
            {
                return this._NTTxMaskFlatDetailItems;
            }
            set
            {
                this._NTTxMaskFlatDetailItems = value;
            }
        }
    }
}
