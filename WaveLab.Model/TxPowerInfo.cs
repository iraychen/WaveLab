...
{
    public class TxPowerInfo
    {
        
        private string _Model;

        private int _TxPowerId;
        ...
        private IList<TxPowerTableInfo> _TxPowerTableItems;
        ...
        public int TxPowerId
        {
            get
            {
                return this._TxPowerId;
            }
            set
            {
                this._TxPowerId = value;
            }
        }
        ...
        public IList<TxPowerTableInfo> TxPowerTableItems
        {
            get
            {
                return this._TxPowerTableItems;
            }
            set
            {
                this._TxPowerTableItems = value;
            }
        }
    }
}
