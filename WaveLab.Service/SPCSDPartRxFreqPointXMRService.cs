...
{
    public class SPCSDPartRxFreqPointXMRService : ISPCSDPartRxFreqPointXMRService
    {
        public ISPCSDPartRxFreqPointXMR dal;
        ...
        public void SaveException(int ReturnLossPK, IList<SPCSDPartRxFreqPointException> ExceptionItems)
        {
