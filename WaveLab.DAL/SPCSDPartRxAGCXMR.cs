...
{
    public class SPCSDPartRxAGCXMR : AdoDaoSupport, ISPCSDPartRxAGCXMR
    {
        public int QueryHistory(Hashtable hashTable)
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append(" SELECT DISTINCT COUNT(*) ");
            cmdText.Append(" FROM SPC_SDPart_Rx_AGC_XMR ");
        ...
        public IList<SPCSDPartRxAGCXMRInfo> QueryHistory(Hashtable hashTable, string sortBy, string orderBy, int page, int pageSize)
        {
            StringBuilder cmdText = new StringBuilder();
            ...
            return AdoTemplate.QueryWithRowMapperDelegate<SPCSDPartRxAGCXMRInfo>(CommandType.Text, cmdText.ToString(), delegate(IDataReader reader, int row)
            {
                SPCSDPartRxAGCXMRInfo item = new SPCSDPartRxAGCXMRInfo();
        ...
        public SPCSDPartRxAGCXMRInfo Get(int XMRPK)
        {
            IDbParametersBuilder paras = base.CreateDbParametersBuilder();
            ...
            DetailCmdText.Append("FROM SPC_SDPart_Rx_AGC_Detail ");
            DetailCmdText.Append("WHERE XMR_PK=@XMR_PK ");
            DetailCmdText.Append("ORDER BY No_Of_Times ASC ");

            IList<SPCSDPartRxAGCDetail> DetailItems = AdoTemplate.QueryWithRowMapperDelegate<SPCSDPartRxAGCDetail>(CommandType.Text, DetailCmdText.ToString(), delegate(IDataReader reader, int row)
            {
                SPCSDPartRxAGCDetail item = new SPCSDPartRxAGCDetail();
            ...
            ExceptionCmdText.Append("FROM SPC_SDPart_Rx_AGC_Exception ");
            ExceptionCmdText.Append("WHERE XMR_PK=@XMR_PK ");

            IList<SPCSDPartRxAGCException> ExceptionItems = AdoTemplate.QueryWithRowMapperDelegate<SPCSDPartRxAGCException>(CommandType.Text, ExceptionCmdText.ToString(), delegate(IDataReader reader, int row)
            {
                SPCSDPartRxAGCException item = new SPCSDPartRxAGCException();
                item.NoOfTimes = Convert.ToInt32(reader["No_Of_Times"]);
                item.TestingDate = Convert.ToDateTime(reader["Testing_Date"]);
            ...
            return AdoTemplate.QueryForObjectDelegate<SPCSDPartRxAGCXMRInfo>(CommandType.Text, cmdText.ToString(), delegate(IDataReader reader, int row)
            {
                SPCSDPartRxAGCXMRInfo entity = new SPCSDPartRxAGCXMRInfo();
        ...
        public void SaveException(int XMRPK, IList<SPCSDPartRxAGCException> ExceptionItems)
        {
            StringBuilder cmdText = new StringBuilder();
            IDbParametersBuilder paras = base.CreateDbParametersBuilder();
            ...
            {
                cmdText.Append(" INSERT INTO SPC_SDPart_Rx_AGC_Exception");
