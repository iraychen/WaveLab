...
{
    public class SPCSDPartRxFreqPoint : AdoDaoSupport, ISPCSDPartRxFreqPoint
    {
        public IList<string> GetStationItems()
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("SELECT distinct Station_No ");
            cmdText.Append("FROM v_SPC_Rx_Power_FreqPoint   ");
        ...
        public IList<SPCSDPartRxFreqPointInfo> Query(Hashtable hashTable, string sortBy, string orderBy)
        {
            ...
            cmdText.Append(" ,a.CH,a.PW,a.Serial_No ");
            cmdText.Append(" FROM  v_SPC_Rx_Power_FreqPoint   a ");
            ...
            return AdoTemplate.QueryWithRowMapperDelegate<SPCSDPartRxFreqPointInfo>(CommandType.Text, cmdText.ToString(), delegate(IDataReader reader, int row)
            {
                SPCSDPartRxFreqPointInfo item = new SPCSDPartRxFreqPointInfo();
        ...
        public int GetSDParts(Hashtable hashTable)
        {
            ...
            cmdText.Append("FROM SPC_SDPart_Rx_FreqPoint ");
            cmdText.Append("WHERE 1=1 ");
        ...
        public IList<SPCSDPartRxFreqPointInfo> GetSDParts(Hashtable hashTable, string sortBy, string orderBy, int page, int pageSize)
        {
            ...
            cmdText.Append("SDPart_PK,Station_No,Divide,CH_No,CH,PW,Serial_No,LSL,USL,Enable ");
            cmdText.Append("FROM SPC_SDPart_Rx_FreqPoint ");
            cmdText.Append("WHERE 1=1 ");
        ...
        public bool CheckExists(string StationNo, char Divide, string CHNo, string CH, string PW, string SerialNo)
        {
            ...
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("SELECT COUNT(*) FROM SPC_SDPart_Rx_FreqPoint ");
        ...
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("INSERT INTO SPC_SDPart_Rx_FreqPoint ");
            cmdText.Append("(Station_No,Divide,CH_No,CH,PW,Serial_No,LSL,USL,Enable,Last_Update_Date,Last_Updated_By) ");
        ...
        public SPCSDPartRxFreqPointInfo Get(int SDPartPK)
        {
            ...
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("SELECT SDPart_PK,Station_No,Divide,CH_No,CH,PW,Serial_No,LSL,USL,Enable ");
            cmdText.Append("FROM SPC_SDPart_Rx_FreqPoint ");
            cmdText.Append("WHERE 1=1 ");
            cmdText.Append("AND SDPart_PK=@SDPart_PK ");


            return AdoTemplate.QueryForObjectDelegate<SPCSDPartRxFreqPointInfo>(CommandType.Text, cmdText.ToString(), delegate(IDataReader reader, int row)
            {
        ...
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("UPDATE SPC_SDPart_Rx_FreqPoint ");
            cmdText.Append("SET ");
        ...
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("DELETE  FROM SPC_SDPart_Rx_FreqPoint  ");
