...
{
    public class SPCSDPartRxPower : AdoDaoSupport, ISPCSDPartRxPower
    {
        public IList<string> GetStationItems()
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("SELECT distinct Station_No ");
            cmdText.Append("FROM NT_Rx_Power_List  ");
        ...
        public IList<SPCSDPartRxPowerInfo> Query(Hashtable hashTable, string sortBy, string orderBy)
        {
            ...
            cmdText.Append(" ,'128QAM' as Mode,b.CH,b.Rx_Power as PW,a.Serial_No ");
            ...
            return AdoTemplate.QueryWithRowMapperDelegate<SPCSDPartRxPowerInfo>(CommandType.Text, cmdText.ToString(), delegate(IDataReader reader, int row)
            {
                SPCSDPartRxPowerInfo item = new SPCSDPartRxPowerInfo();
        ...
        public int GetSDParts(Hashtable hashTable)
        {
            ...
            cmdText.Append("FROM SPC_SDPart_Rx_Power ");
            cmdText.Append("WHERE 1=1 ");
        ...
        public bool CheckExists(string StationNo, char Divide,string CHNo, string Mode, string CH, string PW, string SerialNo)
        {
            ...
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("SELECT COUNT(*) FROM SPC_SDPart_Rx_Power ");
        ...
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("INSERT INTO SPC_SDPart_Rx_Power ");
        ...
        public SPCSDPartRxPowerInfo Get(int SDPartPK)
        {
            IDbParametersBuilder paras = base.CreateDbParametersBuilder();
            ...
            return AdoTemplate.QueryForObjectDelegate<SPCSDPartRxPowerInfo>(CommandType.Text, cmdText.ToString(), delegate(IDataReader reader, int row)
            {
                SPCSDPartRxPowerInfo entity = new SPCSDPartRxPowerInfo();
        ...
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("UPDATE SPC_SDPart_Rx_Power ");
            cmdText.Append("SET ");
        ...
        {
            StringBuilder cmdText = new StringBuilder();
            cmdText.Append("DELETE  FROM SPC_SDPart_Rx_Power  ");
